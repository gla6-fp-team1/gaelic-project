...
import NextSentenceUser from "./NextSentenceUser";
		...
		<>
			...
			<div className="margin">
				...
				<main role="main" className="flex">
					<div>
						<NextSentenceUser setNextOriginalText={setNextOriginalText} />
					</div>
					...
					<div>
						<NoneOfTheSuggestions setNextOriginalText={setNextOriginalText} user={user} />
					</div>
					<div>
						<UserSuggestion
							randomText={randomText}
